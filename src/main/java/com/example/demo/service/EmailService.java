    ...
    public void sendWelcomeEmail(String toEmail, String name) {
        try {
            ...
            String html = """
                <!DOCTYPE html>
                <html>
                <body style="font-family:'DM Sans',sans-serif;background:#04050f;color:#e8eaf6;padding:2rem;margin:0;">
                  <div style="max-width:500px;margin:0 auto;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:24px;padding:2.5rem;">
                    ...
                    <h1 style="font-size:1.5rem;background:linear-gradient(135deg,#00e5ff,#7b2fff);-webkit-background-clip:text;-webkit-text-fill-color:transparent;">
                      Sabscribekaro 🚀
                    </h1>
                    
                    <h2 style="font-size:1.8rem;margin:1rem 0;">
                      Welcome, %s! 🎉
                    </h2>
                    ...
                    <div style="background:rgba(0,229,255,0.06);border:1px solid rgba(0,229,255,0.15);border-radius:16px;padding:1.5rem;margin:1.5rem 0;">
                      <p style="margin:0;font-size:0.95rem;">🎁 <strong>Your Free Trial Includes:</strong></p>
                    ...
                    <a href="https://web-production-6a6fb.up.railway.app/dashboard"
                       style="display:inline-block;padding:0.9rem 2rem;border-radius:99px;background:linear-gradient(135deg,#7b2fff,#00e5ff);color:#fff;font-weight:700;text-decoration:none;margin-top:1rem;">
                      Go to Dashboard →
                    </a>
